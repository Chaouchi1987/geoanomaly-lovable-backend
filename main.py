...
def init_ee() -> dict[str, Any]:
    ...
    with EE_LOCK:
        try:
            ...
            # Render/environment variables can contain a trailing CR/LF.
            # Strip it before Google client libraries use the project ID in
            # HTTP headers.
            project = (
            ...
            if oauth_json:
                ...
                if credentials is None:
                    raise RuntimeError(
                        "Earth Engine persistent OAuth credentials could not be loaded."
                    )
